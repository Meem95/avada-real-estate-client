...
<section className="py-6 b text-black">
	<div className="container mx-auto p-4 sm:p-10">
		<div className="mb-16 space-y-4 text-center">
			...
			<div>
				<button className="px-4 py-1 font-semibold border rounded-l-lg bg-[#65bc7b] border-[#65bc7b] text-black">Monthly</button>
				<button className="px-4 py-1 border rounded-r-lg border-[#65bc7b]">Annually</button>
			</div>
		</div>
