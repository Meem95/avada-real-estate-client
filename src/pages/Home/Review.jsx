    ...
    <div className="max-w-7xl mx-auto my-16">
      <div className="text-center mb-10">
        <h1 className="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">
          Latest  <span className="text-[#65bc7b]">Review</span>
        </h1>
        <p className="max-w-5xl mx-auto mt-4 text-gray-500">
          Our customers' satisfaction is our top priority. Hear from our happy
          clients who have found their dream homes and experienced exceptional
          service. Discover why we're the trusted choice in real estate.
        </p>
      </div>
      <div className="my-5">
        <Swiper
              ...
              <div className="p-6 sm:p-12  text-black">
                <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="w-16 h-1 bg-[#65bc7b] mt-1 mx-auto md:mx-0"></div>
                    <h2 className="text-sm  font-semibold text-center md:text-left">
                      {" "}
                     {item.title}
                    </h2>
